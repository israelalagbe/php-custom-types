...
class _ArrayTest extends \PHPUnit\Framework\TestCase
{
    public function setUp(): void{
        parent::setUp();
		$this->array = new _Array(array(1, 2, 3));
	}
	...
	public function testFrom(){
		$this->assertEquals(_Array::from(array(1, 2, 3)), $this->array);
		
		// Copy!
		$copy = _Array::from($this->array);
	...
	public function testSlice(){
		...
		$this->assertTrue($sliced instanceof _Array);
	...
	public function testClean(){
		$array = new _Array(array(0, null, '0', 1, '', 2, 3, false));
	...
	public function testKeys(){
		...
		$this->assertTrue($keys instanceOf _Array);
		$this->assertEquals($keys(), array(0, 1, 2));
	}
	
	public function testValues(){
		$values = $this->array->values();
		$this->assertTrue($values instanceOf _Array);
	...
	public function testAppend(){
		$this->array->append(new _Array(array(4, 5, 6)))->append(array(7, 8, 9));
	...
	public function testFilter(){
		$filtered = $this->array->filter(function($value, $key){
			return ($value >= 2);
		}, true);
		
		$this->assertTrue($filtered instanceof _Array);
